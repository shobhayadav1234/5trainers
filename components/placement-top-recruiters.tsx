      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-16">
          <p className="text-gray-600 text-lg leading-relaxed mb-8">
            At <span className="font-bold text-gray-900">Mindweave Academy</span>, we take pride in our outstanding 99% placement rate. 
            ...
            the digital marketing and IT industry within months of course completion. Let's dive into how Mindweave Academy 
        ...
        <div className="mb-20">
          ...
          <p className="text-gray-600 mb-8">
            Our 99% placement rate speaks volumes about the quality of training and placement support we offer at Mindweave Academy. 
        ...
        <div className="bg-gray-50 rounded-2xl p-8 md:p-12 border border-gray-100 shadow-sm">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              ...
              Mindweave Academy graduates work at some of the best-known brands, thanks to our comprehensive training 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h4 className="font-bold text-[#20C9B0] mb-4 flex items-center gap-2">
                <Briefcase size={20} />
                Companies Recruiting Mindweave Academy Graduates:
              </h4>
            ...
            <div className="bg-[#20C9B0] text-white p-8 rounded-xl flex flex-col justify-center items-center text-center">
              ...
              <button className="bg-white text-[#20C9B0] px-8 py-3 rounded-lg font-bold flex items-center gap-2 hover:bg-gray-100 transition-colors">
