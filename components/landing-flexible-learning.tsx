    ...
    <section className="py-14 bg-white text-slate-900 font-sans">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          {/* Weekday */}
          <div className="bg-black border border-gray-800 rounded-3xl p-8 hover:border-[#14b8a6]/50 hover:shadow-xl transition-all">
          ...
          {/* Weekend */}
          <div className="bg-black border border-gray-800 rounded-3xl p-8 hover:border-[#5b7cfd]/50 hover:shadow-xl transition-all">
            <div className="flex items-center justify-between mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {[
            ...
            <div
              key={i}
              className="bg-black border border-gray-800 rounded-3xl p-8 text-center hover:shadow-xl hover:border-gray-700 transition-all"
            >
              <div
                className={`w-14 h-14 mx-auto mb-4 rounded-2xl bg-gray-900 border border-gray-700 flex items-center justify-center ${item.color}`}
              >
                <item.icon size={26} />
              </div>
