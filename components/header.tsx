...

  {
    ...
    dropdown: [
      ...
      },
      {
        ...
        sub: [
          { name: "HTML", href: "/courses/html" },
          { name: "CSS", href: "/courses/css" },
      ...
      },
      {
        ...
        sub: [
          { name: "SEO", href: "/courses/seo" },
          { name: "SEM", href: "/courses/sem" },
          { name: "Google Ads", href: "/courses/google-ads" },
          { name: "Content Marketing", href: "/courses/content-marketing" },
          { name: "Email Marketing", href: "/courses/email-marketing" },
      ...
      },
      {
        name: "Python",
        sub: [
          { name: "Basics", href: "/courses/python-basics" },
          { name: "Django", href: "/courses/django" },
          { name: "Flask", href: "/courses/flask" },
          { name: "Data Science", href: "/courses/data-science" },
          { name: "Automation", href: "/courses/automation" },
      ...
      },
      {
        ...
        sub: [
          ...
          { name: "Pen Testing", href: "/courses/pen-testing" },
          { name: "Kali Linux", href: "/courses/kali-linux" },
          { name: "Network Security", href: "/courses/network-security" },
          { name: "Cryptography", href: "/courses/cryptography" },
          { name: "SOC", href: "/courses/soc" },
        ],
      },
