...
const courses = [
  ...
  },
  {
    ...
    desc: "Learn variables, functions, OOP, modules and real-world pr   ogramming skills.",
  },
];

export default function TrendingCourses() {
  return (
    <section className="w-full px-4 md:px-6 py-2">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-20">
        ...
        <button className="mt-3 md:mt-0 bg-gradient-to-r from-blue-600 to-purple-500 text-white px-5 py-2 text-sm md:text-base rounded-full font-medium shadow-md hover:opacity-90">
          View All Courses →
        </button>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
        ...
        {courses.map((item, i) => (
          ...
          >
            ...
            {/* IMAGE (BIGGER BUT CLEAN) */}
            <div className="sm:w-1/4">
              <img
                src={item.img}
                alt="course"
                className="w-full h-100 sm:h-full object-cover"
              />
            </div>

            {/* CONTENT (COMPACT) */}
            <div className="sm:w-1/3 p-3 md:p-4 flex flex-col justify-center">
              ...
              {/* CONTACT */}
              <p className="text-blue-600 text-xs md:text-sm mt-2 font-medium">
                +91 7428748577 | +91 7428748576
              </p>
